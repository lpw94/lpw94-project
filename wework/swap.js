...
calltrk_nearestTLD = function() {
  ...
  for(var i = pieces.length - 1; i >= 0; i--) {
    ...
    namespace_297726181.createCookie('calltrk_nearest_tld', domain, 365, domain);
    if (cookieStr !== document.cookie) {
      namespace_297726181.eraseCookie('calltrk_nearest_tld', domain)
...
namespace_297726181.createCookie = function(name,value,days,domain) {
  if (days) {
    var date = new Date();
...
namespace_297726181.readTransitionalCookie = function(name) {
  var session_ids = namespace_297726181.cookieValues(name);
  if (session_ids.length > 1) {
    namespace_297726181.eraseCookie(name);
    return namespace_297726181.readCookie(name);
  } else {
    return session_ids[0];
  }
};

namespace_297726181.cookieValues = function(name) {
  var nameEQ = name + "=";
...
namespace_297726181.readCookie = function(name) {
  var nameEQ = name + "=";
  var ca = document.cookie.split(';');
  for(var i=0;i < ca.length;i++) {
    var c = ca[i];
...
namespace_297726181.eraseCookie = function(name, domain) {
  namespace_297726181.createCookie(name,"",-1,domain);
};
...
namespace_297726181.getReferrer = function(){
  var referrer = namespace_297726181.readTransitionalCookie('calltrk_referrer');
  if (!referrer) {
    referrer = namespace_297726181.getCurrentReferrer();
  }
  namespace_297726181.createCookie('calltrk_referrer', referrer, 365, calltrk_nearestTLD());
  return referrer;
}

// Returns the current referrer without looking at the cookie
namespace_297726181.getCurrentReferrer = function(){
  var referrer;
  if(namespace_297726181.getURLParameter('utm_referrer')){
    referrer = namespace_297726181.getURLParameter('utm_referrer');
  }else{
...
namespace_297726181.getLanding = function(){
  var landing = namespace_297726181.readTransitionalCookie('calltrk_landing');
  if (!landing) {
    landing = document.URL;
  }
  namespace_297726181.createCookie('calltrk_landing', landing, 365, calltrk_nearestTLD());
  return landing;
}

// Returns the current landing without looking at the cookie
namespace_297726181.getCurrentLanding = function(){
  var landing;
  landing = document.URL;
  return landing;
}

namespace_297726181.getReferrerKey = function(referrer, landing){
  var referrer_key;
  if(referrer.match(/^(.*)doubleclick(.*)$/) || landing.match(/^(.*)gclid=(.*)$/)) {
    ...
    referrer_key = namespace_297726181.getReferrerDomain(referrer);
  }
  return referrer_key;
}

// Get the domain name of the referrer
namespace_297726181.getReferrerDomain = function(referrer){
...
namespace_297726181.checkLanding = function(landing, target){
  return (landing.indexOf(target) !== -1);
}

namespace_297726181.getHostnameAndPath = function() {
  var temp_a = document.createElement("a");
  temp_a.href = document.location.href;
  return temp_a.hostname + temp_a.pathname;
}

namespace_297726181.getURLParameter = function(name) {
  return decodeURIComponent((new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(location.search)||[,""])[1].replace(/\+/g, '%20'))||null;
}



namespace_297726181.makePhoneSwapVisible = function(){
  calltrk_jq('.phoneswap').css("visibility", "visible");
}


namespace_297726181.swapPhoneNumber = function(old_number, new_number) {
  ...
  namespace_297726181.makePhoneSwapVisible();
}

calltrk_domPhoneNumbers = function() {
  var re = new RegExp("(\\(?)\\d{3}(\\))?([-. ]?)\\d{3}([-. ]?)\\d{4}","g");
...
namespace_297726181.swapPhonePlainText = function(search_text, replacement_text, replacement_number){
...
namespace_297726181.swapPhonePlainTextForUpdate = function(replacement_text, old_number, replacement_number){
  var old_123 = old_number.substring(0,3);
  var old_456 = old_number.substring(3,6);
  var old_6789 = old_number.substring(6,10);
...
namespace_297726181.checkPhonePlainText = function(search_text){
...
namespace_297726181.getVWOCookies = function() {
...
namespace_297726181.getUnbounceCookies = function() {
  var unbounce_variations;
  if(namespace_297726181.readCookie('calltrk_unbounce_variations')){
    unbounce_variations = namespace_297726181.readCookie('calltrk_unbounce_variations');
  }else{
    unbounce_variations = '';
  }

  if(namespace_297726181.readCookie('ubpv')){
    variation = namespace_297726181.readCookie('ubpv')[0];
    current_page = namespace_297726181.getHostnameAndPath();
    ...
    namespace_297726181.createCookie('calltrk_unbounce_variations', unbounce_variations, 365);
  }

  return unbounce_variations;
}

namespace_297726181.getGoogleContentExperimentCookies = function() {
  var google_experiments;
  if(namespace_297726181.readCookie('calltrk_google_experiments')){
    google_experiments = namespace_297726181.readCookie('calltrk_google_experiments');
  }else{
    google_experiments = '';
  }

  if(namespace_297726181.getURLParameter('utm_expid')){
    experiment = namespace_297726181.getURLParameter('utm_expid');
    current_page = namespace_297726181.getHostnameAndPath();
    ...
    namespace_297726181.createCookie('calltrk_google_experiments', google_experiments, 365);
  }
...
namespace_297726181.getSecondScript = function(sessionSwapTargets, record_pageview){
  var ns = namespace_297726181;
  var params = {
  ...
  calltrk_jq.ajax({
    url: "//app.calltrk.com/companies/297726181/847b9b374370a6e4507e/10/swap_session.js",
    dataType: 'script',
    cache: false,
    data: params
  })
...
namespace_297726181._log = [];
namespace_297726181._dolog = (window.location.href.indexOf("crdbg") != -1)
namespace_297726181.log = function(what) {
  if (namespace_297726181._dolog) {
    namespace_297726181._log.push(what);
  }
}

namespace_297726181.startSessionSwap = function(reassigns) {
  var swaps = namespace_297726181.getStoredSwaps();
  var replaceNumber;
  ...
  for(var target in swaps) {
    if (target.indexOf(',') === -1) {
      namespace_297726181.swapPhoneNumber(target, swaps[target]);
    } else {
      ...
      if (calltrk_jq.isArray(swaps[target])) {
        namespace_297726181.swapPhonePlainTextForUpdate(replacement_text, swaps[target][0], swaps[target][1]);
      } else {
        namespace_297726181.swapPhonePlainText(search_text, replacement_text, swaps[target]);
      }
    }
  }
...
namespace_297726181.getSessionSources = function(swapTarget) {
  return namespace_297726181.swapTargets[swapTarget];
}

namespace_297726181.findSwapTargets = function() {
  var targets = [];
  ...
  for (var i = 0; i < exactTargets.length; i++) {
    ...
    if (namespace_297726181.checkPhonePlainText(swapText)) {
...
namespace_297726181.checkSessionSwap = function() {
  namespace_297726181.checkSessionSwapInternal(true);
}

namespace_297726181.setStoredSwaps = function(swaps) {
  var cookieStrings = [];
  for(var target in swaps) {
    if (!swaps[target]) {
      continue;
  ...
  namespace_297726181.createCookie('calltrk_session_swap_numbers_297726181', cookieStr, 365, calltrk_nearestTLD());
};

namespace_297726181.mergeStoredSwaps = function(swaps) {
  var swapsStored = namespace_297726181.getStoredSwaps();
  for (var target in swaps) {
    swapsStored[target] = swaps[target];
  }

  namespace_297726181.setStoredSwaps(swapsStored);
};

namespace_297726181.getStoredSwaps = function() {
  var swap, result;
  var swapsStored = namespace_297726181.readCookie('calltrk_session_swap_numbers_297726181');
...
namespace_297726181.checkSessionSwapInternal = function(recordPageView) {
  var possibleTargets = namespace_297726181.findSwapTargets();
  var storedSwaps = namespace_297726181.getStoredSwaps();
  ...
  if (foundStoredTarget) {
    ...
    namespace_297726181.addLoadEvent(namespace_297726181.startSessionSwap);
  }
  ...
  namespace_297726181.getSecondScript(swapsToVerify, recordPageView);
};

namespace_297726181.swapPhoneForUpdate = function(reassigns){
  namespace_297726181.startSessionSwap(reassigns);
...
namespace_297726181.getSessionID = function(){
  var idKey = 'calltrk_session_id_297726181';
  var session_id = namespace_297726181.readTransitionalCookie(idKey);

  if (!session_id) {
    session_id = namespace_297726181.generateUUID();
  }

  namespace_297726181.createCookie(idKey, session_id, 365, calltrk_nearestTLD());
  return session_id;
}

namespace_297726181.generateUUID = function(){
...
namespace_297726181.addLoadEvent = function(new_func){
...
namespace_297726181.startSourceSwap = function(){
  namespace_297726181.sourceSwap(namespace_297726181.referrer_key);
...
namespace_297726181.contains = function(a, obj) {
...
namespace_297726181.sourceSwap = function(referrer_key) {
  var old_number, new_number, search_text, replacement_text, ref_swap, landing_target, landing_swap;
      keys_87008 = ['yelp.com'];
      ref_swap = namespace_297726181.contains(keys_87008, referrer_key);

        landing_swap = true;

      track_all_87008 = false;
      if( (ref_swap && landing_swap) || track_all_87008){
        
            old_number = '6467477130';
            new_number = '8778688335';
            namespace_297726181.swapPhoneNumber(old_number, new_number);
        
      }
      keys_69182 = ['google_organic'];
      ref_swap = namespace_297726181.contains(keys_69182, referrer_key);

        landing_swap = true;

      track_all_69182 = false;
      if( (ref_swap && landing_swap) || track_all_69182){
        
            old_number = '6467477130';
            new_number = '8777962434';
            namespace_297726181.swapPhoneNumber(old_number, new_number);
        
      }
      keys_74003 = ['google_organic', 'google_paid', 'google_local', 'yahoo_organic', 'yahoo_paid', 'yahoo_local', 'bing_organic', 'bing_paid', 'bing_local'];
      ref_swap = namespace_297726181.contains(keys_74003, referrer_key);

        landing_swap = true;

      track_all_74003 = false;
      if( (ref_swap && landing_swap) || track_all_74003){
        
            old_number = '6467609600';
            new_number = '8776597606';
            namespace_297726181.swapPhoneNumber(old_number, new_number);
...
(function() {
  ...
  ns.getIntegrationData = function() {
    ...
    $.each(ic, function(intName, dataSet) {
      $.each(dataSet.cookies, function(index, cookie) {
        params[intName + "_" + cookie] = ns.readCookie(cookie);
      });
  ...
  ns.integrationRetry = function() {
    ...
    calltrk_jq.ajax({
      url: "//app.calltrk.com/companies/297726181/847b9b374370a6e4507e/10/icap.js",
      dataType: 'script',
      cache: false,
      data: data
    });
...
namespace_297726181.referrer = namespace_297726181.getReferrer();
namespace_297726181.landing = namespace_297726181.getLanding();
namespace_297726181.referrer_key = namespace_297726181.getReferrerKey(namespace_297726181.referrer, namespace_297726181.landing);


namespace_297726181.addLoadEvent(namespace_297726181.startSourceSwap);
namespace_297726181.addLoadEvent(namespace_297726181.checkSessionSwap);

(function() {
  var cfg = {"enabled":false,"all_pages":false,"url_whitelist":["https://www.wework.com/locations/boston/south-station","https://www.wework.com/locations/boston/fort-point"]};
  var $ = calltrk_jq, namespace = namespace_297726181,
  ...
  function sendData(data) {
    ...
    var reportUrl = "//app.calltrk.com/companies/297726181/847b9b374370a6e4507e/10/form_capture";
  ...
  namespace.captureForm = function(form) {
    ...
    if (namespace.readCookie('calltrk_session_id_297726181')) {
...
(function() {
  ...
  window.CallTrk = window.CallTrk || {
    ...
    captureForm: function(node_or_selector) {
      var form = calltrk_jq(node_or_selector),
          namespaces = window.CallTrk._namespaces, ns = null;
      for(var i = 0; i < namespaces.length; ++i) {
        ns = window[namespaces[i]];
  ...
  // 
  pushNamespace("namespace_297726181");
